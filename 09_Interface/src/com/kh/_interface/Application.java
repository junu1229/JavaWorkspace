 ...
 * - 클래스와 인터페이스의 관계일 때 : 구현 클래스명 implements 인터페이스명, 인터페이스명, 인터페이스명, ,,,
 * - 인터페이스 간에 상속 관계일 때 : 인터페이스명 extends 인터페이스명, 인터페이스명, 인터페이스명, , , 
 * 
 */
...
//		Vehicle vehicle = new Vehicle; 이렇게 사용 안됨
		Vehicle bus = new Bus();
