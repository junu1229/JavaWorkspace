 ...
 * 
 * Predicate
 * - Predicate 함수적 인터페이스는 매개 변수와 boolean 값을 리턴하는 textXXX() 추상 메서드를 가지고 있다.
 * - testXXX() 추상 메서드는 매개값을 조사해서 true/false를 리턴하는 역활을 한다.
 * 
 */
...
//		e.method2(student1, student2);
	...
	public void method2(Student stu1, Student stu2) {
		...
		System.out.println(bp.test(stu1, stu2));
	...
	public void method3() {
		...
		System.out.println(ip.test(91));
		System.out.println(ip.test(201));
