...
//		c.practice11();
	...
	public void practice5() {
		...
		if (buyPrice >= 500000) { // "이상"
			buyPrice *= 0.8;
		} else if (buyPrice >= 300000) { // "이상"
			buyPrice *= 0.9;

		} else if (buyPrice >= 100000) { // "이상" --> =가 빠졌어요! 초과로 입력했네요ㅠㅠ 감사합니다!
			buyPrice *= 0.95;
	...
	public void practice6() {
		...
		if (degree < 0) { // 요거까지 세심하게 신경 써주시다니~ 좋아요 :)
	...
	public void practice11() {
		...
		// 혹시나 조건식에서 공통적으로 들어가는 부분 빼고 싶다면 중첩 if문으로 바꾸면 좋아요 :)
	...
	public void practice11_1() {
		...
		// 혹시나 조건식에서 공통적으로 들어가는 부분 빼고 싶다면 중첩 if문으로 바꾸면 좋아요 :) 이런 방식 말씀이실까요?
		if (totalScore > 70) {
			if (attendance > 70 * 0.2) {
				System.out.println("중간고사 점수(20) : " + middleScore * 0.2);
				System.out.println("기말고사 점수(30) : " + finalScore * 0.3);
