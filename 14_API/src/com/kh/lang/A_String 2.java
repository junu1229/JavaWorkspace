 ...
 * - 자바에서 API는 프로그램 개발에 자주 사용되는 클래스 및 인터페이스 모음
 * 
 * 
 * java.lang 패키지
...
//		a.method4();
	...
	public void method1() {
		...
		System.out.println("str2 == str3 : "+(str3 == str2)); // false
		System.out.println("str4 == str3 : "+(str3 == str4)); // false
		...
		System.out.println("str1.toString() : "+str4.toString());
	...
	public void method2() {
		...
		// 6. toUpperCase() / toLowerCase() : String - 문자열을 모두 대/서문자로 변경한 새로운 문자열을 생성해서 리턴
		...
		// 9. static valueOf([기본 자료형, 문자배열, 객체]) : String - 정적 메서드는 매개변수로 입력받는 값들을 문자열로 변경해서 리턴
